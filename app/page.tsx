          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {appVersions.map((version, index) => (
                <div key={index} className={`p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl border ${version.new
                  ? 'border-primary/30 bg-gradient-to-b from-primary/10 to-transparent'
                  : 'border-white/10 bg-surface/30'
                  } backdrop-blur-sm`}>
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <div className="flex items-center gap-2 md:gap-3">
                      <div className={`w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center ${version.new
